...
parser.add_argument("--logit-softcap", type=float, default=20.0, help="apply tanh logit softcap; set 0 to disable")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        window_pattern=args.window_pattern, logit_softcap=args.logit_softcap,
    )
